# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/01_Create Project.ipynb (unless otherwise specified).
...
def main(record_path:Param("Path to JUNE simulation records and parameter grid", str),
         force_add_project:Param("Overwrite project if it already exists", store_true),
         test_only:Param("Test behavior without changing files", store_true),
